...
export async function PUT(req: Request, ctx: Ctx) {
    try {
        ...
        if (name !== undefined) {
            updateData.name = { set: String(name) } // NOT NULL
        }
        if (email !== undefined) {
            updateData.email = { set: String(email) } // NOT NULL
        }
        if (bio !== undefined) {
            updateData.bio = { set: bio === null ? null : String(bio) } // nullable
        }
        if (nationality !== undefined) {
            updateData.nationality = { set: nationality === null ? null : String(nationality) } // nullable
        }
